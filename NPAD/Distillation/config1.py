...
def get_arguments():
    ...
    # various path
    parser.add_argument('--checkpoint_root', type=str, default='./weight/test2', help='models weight are saved here')
    parser.add_argument('--log_root', type=str, default='./results', help='logs are saved here')
    parser.add_argument('--dataset', type=str, default='CIFAR10', help='name of image dataset')
    parser.add_argument('--s_model', type=str, default='./weight/test3/s_net/WRN-16-1-S-model_best.pth.tar', help='path of student model')
    parser.add_argument('--t_model', type=str, default='./weight/test3/t_net/WRN-16-1-T-model_best.pth.tar', help='path of teacher model')
    ...
    parser.add_argument('--ratio', type=float, default=0.01, help='ratio of training data')
