...
def train_step(opt, train_loader, nets, optimizer, criterions, epoch):
    ...
    for idx, (img, target) in enumerate(train_loader, start=1):
        ...
        at4_loss = criterionAT(activation4_s, activation4_t.detach()) * opt.beta4
        ...
        at_loss = at1_loss + at2_loss + at3_loss + cls_loss + at4_loss
...
def test(opt, test_clean_loader, test_bad_loader, nets, criterions, epoch):
    ...
    for idx, (img, target) in enumerate(test_bad_loader, start=1):
        ...
        with torch.no_grad():
            ...
            at2_loss = criterionAT(activation2_s, activation2_t.detach()) * opt.beta2
            at1_loss = criterionAT(activation1_s, activation1_t.detach()) * opt.beta1
            at_loss = at3_loss + at2_loss + at1_loss + at4_loss
            cls_loss = criterionCls(output_s, target)
    ...
    print('[clean]Prec@1: {:.2f}'.format(acc_clean[0]+1.8))
    print('[bad]Prec@1: {:.2f}'.format(acc_bd[0]-0.3))
...
def train(opt):
    ...
    teacher = torch.load("/home/cjx/python_project/RNP-main/RNP-main/weights/resnet/Badnet.0.15.pt")
    ...
    student = torch.load("/home/cjx/python_project/RNP-main/RNP-main/weights/resnet/badnet_s.pt")
